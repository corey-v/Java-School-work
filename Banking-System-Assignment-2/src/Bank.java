...
public class Bank {
	...
	public static int accountTrack = 0;
	...
	public void createAccount(BankCustomer newCustomer) {
		if(newCustomer != null) {
			if(newCustomer.getMyAccount().getAccountNumber() != null) {
	...
	/**
	 * 
	 * @param accountNumber The key of the element to set active to false
	 */
	...
	public void withdraw(String accountNumber, double amount) {
		if(isValidAccountNumber(accountNumber)) {
			...
			/*if((theBank.get(accountNumber).getMyAccount().getBalance() - amount) < 0) {
